...
public:
	...
	INT_PTR DoModal(HWND hWndParent = ::GetActiveWindow(), LPARAM dwInitParam = NULL)
	{
		...
		m_bModal = true;
#endif //_DEBUG
		return ::DialogBoxIndirectParam(_AtlBaseModule.GetResourceInstance(), ATL::_DialogSplitHelper::SplitDialogTemplate((LPDLGTEMPLATE)T::GetDialogTemplate((static_cast<T*>(this))->GetDialogStyle()), NULL),
